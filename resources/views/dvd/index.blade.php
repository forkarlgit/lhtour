    ...
    <div class="content-wrap">
        <div class="container clearfix notopmargin">
            <div class="item-container site-banner">
                <img src="{{ asset('img/img-header-dvds-large.jpg') }}" class="img-responsive center-block">
            </div>

            <div class="content-sub-header content-wrapper">
                <div class="inner">
                    <div class="heading"><h1>Lethal Hardcore DVDs @if(isset($tag)) under {{$tag->name}} @endif</h1></div>
                    <div class="sorting">
            ...
            <section class="content-wrapper">
                <aside class="no-category">
                    ...
                    <ul class="category-box">
                        @foreach($tags as $tag)
                        <li><a href="/dvds/tags/{{ $tag->id }}/{{ str_slug( $tag->name) }}">{{ $tag->name }} <span>({{ $tag->dvd_count}})</span></a></li>
                        @endforeach
                    </ul>
                </aside>
                <main>
                            ...
                            <div class="inner">
                                <div class="thumb-wrapper">
                                    <a href="{{ $dvd->link }}">
                                        ...
                                        <div class="thumb">
                                            <img src="{{ asset('img/thumb-dvd-trans.png') }}" alt="">
