    ...
    <div class="content-wrap">
        <div class="container clearfix notopmargin">
            <div class="item-container site-banner">
                <img src="{{ asset('img/img-header-hd_videos-large.jpg') }}" class="img-responsive center-block">
            </div>

            <div class="content-sub-header content-wrapper">
                <div class="inner">
                    <div class="heading"><h1>@if(isset($tag)) under {{$tag->name}} @else XXX @endif Videos</h1></div>
                    <div class="sorting">
                        <div class="level-1-sorts">
                            ...
                            <ul style="display: none" id="dropsort" class="ddn">
                                <li><a href="/updates?o=d">Newest</a></li>
                                <li><a href="/updates?o=r">Top Rated</a></li>
                                <li><a href="/updates?o=v">Most Viewed</a></li>
                                <li><a href="/updates?o=f" class="active">Most Popular</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="flexslider-custom">
                                        <div class="slider-wrap">
                                            <div class="slide">
                                                ...
                                                <a href="{{ $content->link }}">
                                                    <img style="display:none" class="play-button" src="{{ asset('img/icon-play.svg') }}" alt="">
