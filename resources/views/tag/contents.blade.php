    ...
    <div class="content-wrap">
        <div class="container clearfix notopmargin">
            ...
            <div class="content-sub-header content-wrapper">
                <div class="inner">
                    <div class="heading"><h1>@if(isset($tag)) {{$tag->name}} @else XXX @endif Videos</h1></div>
                    <div class="sorting">
                        <div class="level-1-sorts">
                            ...
                            <ul style="display: none" id="dropsort" class="ddn">
                                <li><a href="?o=d">Newest</a></li>
                                <li><a href="?o=r">Top Rated</a></li>
                                <li><a href="?o=v">Most Viewed</a></li>
                                <li><a href="?o=f" class="active">Most Popular</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
